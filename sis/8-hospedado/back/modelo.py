...
class ExameRealizado(db.Model):
    ...
    exame_id =  db.Column(db.Integer, db.ForeignKey(Exame.id, ondelete="CASCADE"), nullable=False)
...
class Respirador(db.Model):
    ...
    pessoa_id = db.Column(db.Integer, db.ForeignKey(Pessoa.id, ondelete="CASCADE"))
